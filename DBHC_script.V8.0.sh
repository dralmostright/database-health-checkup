...
DBHC_DIR=`echo $HOME`"/DBHC/DBHC-"`echo $DDATE_TIME`
RAC_LOG_FILE=""
...
prompt <h2 style="font-size: -webkit-xxx-large;text-align: center;margin-bottom: 25px;">Database Health Checkup Report</h2>
prompt <table border="1" style=" margin: auto; width: 50%;">
prompt <tbody>
prompt <tr><th>Author:</th><th> Nepasoft Solutions Pvt. Ltd.</th></tr>
prompt <tr><th>Date Perofrmed:</th><th>`date +%d-%m-%Y`</th></tr>
prompt </tbody>
prompt </table>
EOF
...
set define off
prompt <h3 style="text-align:center;margin:auto;color: cornflowerblue;text-decoration: underline;"> Copyright &copy; `date +%Y` Nepasoft Solutions Pvt. Ltd.</h3>
...
----********************************************************
prompt <h4>Health of system and sysaux tablespaces:</h4>
...
prompt <html><head><style type="text/css"> h2{color: #336699; text-decoration: underline;} th{color: #336699; background: #cccc99;} h4{font-style: italic; font-size: larger; color:#6697ef; text-decoration: underline; margin: auto; margin-left:5%;} th,td{font-family: monospace;} hr{border-width:4px; border-bottom-color: #000;} br{ display:none; } table{border-spacing: inherit;border-color: #eee;}</style></head><body style=" width:90%; margin: auto;">
EOF
...
echo "# | \ | |                           / _| |    / ____|     | |     | | (_)                 #"
echo "# |  \| | ___ _ __   __ _ ___  ___ | |_| |_  | (___   ___ | |_   _| |_ _  ___  _ __  ___  #"
echo "# | . ' |/ _ \ '_ \ / _' / __|/ _ \|  _| __|  \___ \ / _ \| | | | | __| |/ _ \| '_ \/ __| #"
echo "# | |\  |  __/ |_) | (_| \__ \ (_) | | | |_   ____) | (_) | | |_| | |_| | (_) | | | \__ \ #"
echo "# |_| \_|\___| .__/ \__,_|___/\___/|_|  \__| |_____/ \___/|_|\__,_|\__|_|\___/|_| |_|___/ #"
echo "#            |_|                                                                          #"
echo "#-----------------------------------------------------------------------------------------#"
echo "###########################################################################################"
echo "#-----------------------------------------------------------------------------------------#"
...
echo "--------> Deaflut Directory for saving logs and metrics: ${bold}${underline}$destdir${reset}"
